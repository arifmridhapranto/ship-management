  ...
  var k = {
    ...
    rangePickerMainTpl: function (G, K, H, M, D, o, N) {
      ...
      var B =
        ...
        " " +
        H +
        '" x-placement="center-left"><div class="c-datepicker-picker__body-wrapper">' +
        o +
    ...
    rangePickerMainOnlyTimeTpl: function (B, A) {
      ...
      var C =
        '<div class="c-datepicker-picker c-datepicker-date-range-picker c-datepicker-popper ' +
        A +
        '" x-placement="center-start"><div class="c-datepicker-picker__body-wrapper"><div class="c-datepicker-picker__body"><div class="c-datepicker-date-range-picker__time-header"><div class="c-datepicker-date-range-picker__time-content c-datepicker-date-picker__onlyTime-content">' +
        o +
    ...
    datePickerMainTpl: function (A) {
      ...
      var B =
        '<div class="c-datepicker-picker c-datepicker-date-picker c-datepicker-popper {{hasTime}} {{hasSidebar}}" x-placement="center-end"><div class="c-datepicker-picker__body-wrapper">{{sidebar}}<div class="c-datepicker-picker__body"><div class="c-datepicker-date-picker__time-header">' +
        o +
        "</div>" +
        G +
    ...
    datePickerMainOnlyTimeTpl: function (o) {
      ...
      var A =
        ...
        o +
        '" x-placement="center-start"><div class="c-datepicker-picker__body-wrapper"><div class="c-datepicker-picker__body"><div class="c-datepicker-date-picker__time-header c-datepicker-date-picker__onlyTime-content">' +
        C +
        "</div></div></div>" +
        B +
        "</div>";
